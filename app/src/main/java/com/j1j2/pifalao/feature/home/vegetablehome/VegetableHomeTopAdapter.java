 ...
 */
public class VegetableHomeTopAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        draweeView.setImageURI(Uri.parse(BuildConfig.IMAGE_URL+bannerActivities.get(position).getBannerAppImg()));
