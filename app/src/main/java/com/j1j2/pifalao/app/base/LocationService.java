...
public class LocationService {
    ...
    public LocationClientOption getDefaultLocationClientOption() {
        if (mOption == null) {
            ...
            mOption.setOpenAutoNotifyMode(60 * 1000, 200, LocationClientOption.LOC_SENSITIVITY_HIGHT);//分别为频率，距离，敏感程度设置后，SDK会按照“或”的关系，达到标准才会发起定位
