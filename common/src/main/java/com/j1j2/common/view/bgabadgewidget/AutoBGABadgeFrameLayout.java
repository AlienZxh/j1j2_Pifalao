 ...
 */
public class AutoBGABadgeFrameLayout extends AutoFrameLayout implements BGABadgeable {

    private BGABadgeViewHelper mBadgeViewHeler;

    public AutoBGABadgeFrameLayout(Context context) {
        this(context, null);
    }

    public AutoBGABadgeFrameLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AutoBGABadgeFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
