package com.j1j2.common.view.rotateimageview;
 ...
 */
public class NewRotateImageView extends ImageView {
    ...
    public NewRotateImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
